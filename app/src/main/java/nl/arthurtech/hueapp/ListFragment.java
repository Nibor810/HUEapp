...
public class ListFragment extends Fragment implements LampUpdateCallback{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LampCommunication.lampCommunication.setListener(this);
        new Thread(()->{
            while(true){
                UpdateLamps();
                try {
    ...
    private void UpdateLamps() {
        LampCommunication.lampCommunication.getLamps();
    }
    ...
    private void GetLamps() {
        Log.i(TAG, "addLamps");
        //lamps.add(new LampItem("Lamp 1",1235, brightness, on, saturation));
        //lamps.add(new LampItem("Lamp 2",2725, brightness, on, saturation));
        //lamps.add(new LampItem("Lamp 3",9521, brightness, on, saturation));
    }
